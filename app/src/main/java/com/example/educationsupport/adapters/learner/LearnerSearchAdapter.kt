...
class LearnerSearchAdapter(private val courseList: ArrayList<CourseSearch>, private val context: Context) :
    RecyclerView.Adapter<LearnerSearchAdapter.ViewHolder>(), Filterable {
