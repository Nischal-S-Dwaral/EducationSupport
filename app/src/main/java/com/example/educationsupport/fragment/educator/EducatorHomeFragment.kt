...
class EducatorHomeFragment : Fragment() {
    ...
    private lateinit var myCoursesListAdaptor: EducatorCourseListCardAdapter
    ...
    override fun onCreateView(
        ...
        myCourseListRecyclerView = view.findViewById(R.id.educator_rv_educator_courses_list_cards)
