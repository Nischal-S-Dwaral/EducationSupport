...
object EnrolledCoursesConstants {
    ...
    fun enrolledCourseList() : ArrayList<Course1> {
        val course1 = Course1(
            1,
        ...
        val enrolledCourseList1 = ArrayList<Course1>()
        enrolledCourseList1.add(course1)
        enrolledCourseList1.add(course12)
        enrolledCourseList1.add(course13)
        enrolledCourseList1.add(course14)
        enrolledCourseList1.add(course15)

        return enrolledCourseList1
    }
}